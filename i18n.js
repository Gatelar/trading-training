...
const I18N_DICT = {
  ...
  "ex.statement": { fr: "Affirmation", en: "Statement" },
  "ex.true": { fr: "Vrai", en: "True" },
  "ex.false": { fr: "Faux", en: "False" },
  "ex.right": { fr: "Juste", en: "Right" },
  "ex.wrong": { fr: "Raté", en: "Missed" },
  "ex.isTrue": { fr: "l'affirmation est vraie", en: "the statement is true" },
  "ex.isFalse": { fr: "l'affirmation est fausse", en: "the statement is false" },
  "ex.next": { fr: "Affirmation suivante →", en: "Next statement →" },
  "ex.seeScore": { fr: "Voir le résultat →", en: "See the result →" },
  "ex.allRight": { fr: "Aucune erreur.", en: "No mistakes." },
  "ex.toReview": { fr: "À revoir :", en: "To review:" },
  "ex.restart": { fr: "Refaire cette partie", en: "Redo this part" },
  "ex.check": { fr: "Vérifier", en: "Check" },
  "ex.expected": { fr: "Attendu", en: "Expected" },
  "ex.gridDone": { fr: "Grille complète, tout est juste.", en: "Grid complete, everything is right." },
  "ex.gridEmpty": { fr: "Remplis au moins une case.", en: "Fill in at least one cell." },
  "ex.gridLeftOne": { fr: "case encore fausse ou vide.", en: "cell still wrong or empty." },
  "ex.gridLeftMany": { fr: "cases encore fausses ou vides.", en: "cells still wrong or empty." },
  "ex.stepDone": { fr: "Étape juste.", en: "Step correct." },
  "ex.leftOne": { fr: "réponse encore fausse ou vide.", en: "answer still wrong or empty." },
  "ex.leftMany": { fr: "réponses encore fausses ou vides.", en: "answers still wrong or empty." },
  "ex.asset": { fr: "Actif", en: "Asset" },
  "ex.side": { fr: "Sens", en: "Side" },
  "ex.risk": { fr: "Risque", en: "Risk" },
  "ex.up": { fr: "Monter", en: "Move up" },
  "ex.down": { fr: "Descendre", en: "Move down" },
  "ex.rankDone": { fr: "Classement juste.", en: "Ranking correct." },
  "ex.rankWrong": { fr: "Ce n'est pas l'ordre.", en: "That is not the order." },
  "ex.unsorted": { fr: "Non rangées", en: "Unsorted" },
  "ex.unsortedOne": { fr: "Non rangée", en: "Unsorted" },
  "ex.group": { fr: "Groupe", en: "Group" },
  "ex.newGroup": { fr: "Nouveau groupe", en: "New group" },
  "ex.dropHere": { fr: "Glisse une position ici", en: "Drag a position here" },
  "ex.moveTo": { fr: "Ranger", en: "Move" },
  "ex.groupsIncomplete": { fr: "Range chaque position. Une position qui ne perd avec aucune autre forme un groupe à elle seule.", en: "Place every position. A position that loses with no other forms a group of its own." },
  "ex.groupsWrong": { fr: "Ces groupes ne réunissent pas des positions qui perdent ensemble.", en: "These groups do not bring together positions that lose together." },
  "ex.groupsExpected": { fr: "Les groupes attendus :", en: "The expected groups:" },
  "ex.timeSpent": { fr: "Temps passé sur cette étape", en: "Time spent on this step" },
  "ex.changed": { fr: "Cerclé : le couple a changé de catégorie.", en: "Circled: the pairing has changed category." },
  "ex.showFix": { fr: "Voir la correction", en: "Show the correction" },
  "ex.hideFix": { fr: "Masquer la correction", en: "Hide the correction" },
